...
const AnalyticDashboard = () => {
  return (
    <div className="my-2 py-2 h-[80vh] px-4 md:px-12 bg-slate-200 dark:bg-slate-900">
      {/* Breadcrumb */}
      <div
        className="flex py-1 my-3 text-xs text-gray-700 dark:text-gray-100"
      ...
      <div className="my-4 bg-slate-300 dark:bg-slate-800 px-2 rounded sm:px-4 md:px-8 py-2 ">
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          <a
            ...
            target="_blank"
            className="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded text-xs sm:text-sm px-5 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 "
          >
