package org.excise.rsbcl.dao.employee;
...
public class EmployeeDAO {
    ...
    @NotNull(message = "Personal information cannot be empty")
    private PersonalInfo personalInfo;

    @NotNull(message = "Contact information cannot be empty")
    private ContactInfo contactInfo;

    @NotNull(message = "Identification information cannot be empty")
...
//        private MultipartFile aadharDocumentUrl;
...
//        private MultipartFile pancardDocumentUrl;
    }
